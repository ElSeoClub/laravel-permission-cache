...
use Elseoclub\Permission\Middleware\RoleOrPermissionMiddleware;
use Elseoclub\Permission\Tests\TestModels\UserWithoutHasRoles;
...
class RoleOrPermissionMiddlewareTest extends TestCase {
    ...
    public function the_middleware_can_be_created_with_static_using_method() {
        $this->assertSame(
            'Elseoclub\Permission\Middleware\RoleOrPermissionMiddleware:edit-articles',
            RoleOrPermissionMiddleware::using( 'edit-articles' )
        );
        $this->assertEquals(
            'Elseoclub\Permission\Middleware\RoleOrPermissionMiddleware:edit-articles,my-guard',
            RoleOrPermissionMiddleware::using( 'edit-articles', 'my-guard' )
        );
        $this->assertEquals(
            'Elseoclub\Permission\Middleware\RoleOrPermissionMiddleware:edit-articles|testAdminRole',
