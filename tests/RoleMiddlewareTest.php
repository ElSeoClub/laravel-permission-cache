...
use Elseoclub\Permission\Middleware\RoleMiddleware;
...
class RoleMiddlewareTest extends TestCase {
    ...
    public function the_middleware_can_be_created_with_static_using_method() {
        $this->assertSame(
            'Elseoclub\Permission\Middleware\RoleMiddleware:testAdminRole',
            RoleMiddleware::using( 'testAdminRole' )
        );
        $this->assertEquals(
            'Elseoclub\Permission\Middleware\RoleMiddleware:testAdminRole,my-guard',
            RoleMiddleware::using( 'testAdminRole', 'my-guard' )
        );
        $this->assertEquals(
            'Elseoclub\Permission\Middleware\RoleMiddleware:testAdminRole|anotherRole',
