...
namespace Elseoclub\Permission\Tests;
...
use Elseoclub\Permission\PermissionServiceProvider;
use Elseoclub\Permission\Tests\TestModels\Admin;
use Elseoclub\Permission\Tests\TestModels\Client;
use Elseoclub\Permission\Tests\TestModels\User;

abstract class TestCase extends Orchestra {
    /** @var \Elseoclub\Permission\Tests\User */
    protected $testUser;

    /** @var \Elseoclub\Permission\Tests\Admin */
    protected $testAdmin;

    /** @var \Elseoclub\Permission\Models\Role */
    protected $testUserRole;

    /** @var \Elseoclub\Permission\Models\Role */
    protected $testAdminRole;

    /** @var \Elseoclub\Permission\Models\Permission */
    ...
    protected \Elseoclub\Permission\Models\Permission $testClientPermission;

    protected \Elseoclub\Permission\Models\Role $testClientRole;
    ...
    protected function getEnvironmentSetUp( $app ) {
        ...
        if ( $this->useCustomModels ) {
            $app['config']->set( 'permission.models.permission', \Elseoclub\Permission\Tests\TestModels\Permission::class );
            $app['config']->set( 'permission.models.role', \Elseoclub\Permission\Tests\TestModels\Role::class );
        }
    ...
    protected function setUpDatabase( $app ) {
        ...
        $this->testAdminRole      = $app[ Role::class ]->create( [
            'name'       => 'testAdminRole',
            'guard_name' => 'admin'
        ] );
    ...
    protected function setUpPassport( $app ): void {
        ...
        $this->testClientPermission = $app[ Permission::class ]->create( [
            'name'       => 'edit-posts',
            'guard_name' => 'api'
        ] );
    }
