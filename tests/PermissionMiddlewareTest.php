...
use Elseoclub\Permission\Middleware\PermissionMiddleware;
...
class PermissionMiddlewareTest extends TestCase {
    ...
    public function the_middleware_can_be_created_with_static_using_method() {
        $this->assertSame(
            'Elseoclub\Permission\Middleware\PermissionMiddleware:edit-articles',
            PermissionMiddleware::using( 'edit-articles' )
        );
        $this->assertEquals(
            'Elseoclub\Permission\Middleware\PermissionMiddleware:edit-articles,my-guard',
            PermissionMiddleware::using( 'edit-articles', 'my-guard' )
        );
        $this->assertEquals(
            'Elseoclub\Permission\Middleware\PermissionMiddleware:edit-articles|edit-news',
