...
trait HasPermissionsCache {
    ...
    public function hasDirectPermission( $permission ): bool {
        ...
        $instancePermissions = $this->loadMissingPermissionsCache();

        return $instancePermissions->contains( $permission->getKeyName(), $permission->getKey() );
    }
    ...
    public function givePermissionTo( ...$permissions ) {
        ...
        if ( $model->exists ) {
            $instancePermissions = $this->loadMissingPermissionsCache();
            $currentPermissions  = $instancePermissions->map( fn( $permission ) => $permission->getKey() )->toArray();
        ...
        $this->forgetCacheInstancePermissions();
    ...
    public function getPermissionNames(): Collection {
        ...
        return $instancePermissions->pluck( 'name' );
    }
    ...
    public function loadMissingPermissionsCache() {
        return Cache::tags( get_class( $this ) . ':' . $this->id )->rememberForever( 'permissions', function () {
            return $this->loadMissing( 'permissions' )->permissions;
        } );
    }

    public function forgetCacheInstancePermissions(): void {
